...
<script type="text/javascript">
	function forwardReply() {
		...
		location.href="notice_content_reply_writePro.jsp?boardType=notice&num=<%=board.getNum()%>&name=<%=sId %>&nickName=<%=sName %>&content=" + content;
	}
</script>
</head>
<body>
