	...
	<div id="wrap">
		...
		<article>
			...
			<table id="notice">
				...
				ArrayList<EventDTO> eventList = dao.selectEventList(startRow, listLimit);
				
				for(EventDTO event : eventList) {
				%>
				
				<tr onclick="location.href='event_content.jsp?num=<%=event.getNum() %>'">
					<td><%=event.getNum() %></td>
			...
			<div id="table_search">
				<input type="button" value="글쓰기" class="btn" onclick="location.href='event_write.jsp'">
			</div>
			<%} %>
			<div id="table_search">
				<form action="event_search.jsp" method="get">
			...
			<%
			int eventListCount = dao.selectEventListCount();
